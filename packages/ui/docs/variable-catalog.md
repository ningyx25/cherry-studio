# HuaTuo Studio Variable Catalog
...
2. Use a `stable` HuaTuo Studio product role only when Shadcn has no equivalent product concept.
...
## 5. Stable HuaTuo Studio product variables
