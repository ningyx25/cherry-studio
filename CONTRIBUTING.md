...
7.  **Promote Usage**: Promote HuaTuo Studio through blogs, social media, and other channels to attract more users and developers.
...
To help you get familiar with the codebase, we recommend tackling issues tagged with one or more of the following labels: [good-first-issue](https://github.com/ningyx25/cherry-studio/labels/good%20first%20issue), [help-wanted](https://github.com/ningyx25/cherry-studio/labels/help%20wanted), or [kind/bug](https://github.com/ningyx25/cherry-studio/labels/kind%2Fbug). Any help is welcome.
...
Automated tests are triggered on pull requests (PRs) opened by members of the HuaTuo Studio organization, except for draft PRs. PRs opened by new contributors will initially be marked with the `needs-ok-to-test` label and will not be automatically tested. Once a HuaTuo Studio organization member adds `/ok-to-test` to the PR, the test pipeline will be created.
...
v2 is the next major milestone for HuaTuo Studio, and we invite every developer to actively participate! Whether it's new feature development, architecture optimization, or code refactoring, your contributions on `main` are welcome. Let's build a better HuaTuo Studio together!
...
- WeChat: kangfenmao
- [GitHub Issues](https://github.com/ningyx25/cherry-studio/issues)

Thank you for your support and contributions! We look forward to working with you to make HuaTuo Studio a better product.
