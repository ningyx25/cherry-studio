      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            click: () => {
              void shell.openExternal('https://github.com/ningyx25/cherry-studio/issues/new/choose')
            }
          },
          {
            type: 'custom',
            ...
            click: () => {
              void shell.openExternal('https://github.com/ningyx25/cherry-studio/releases')
            }
          }
        ]
      }
