  ...
  describe('record return cases', () => {
    ...
    it('converts an array of valid entries into a record', async () => {
      ...
      mockFs.readFileSync.mockReturnValue(
        JSON.stringify({
          appDataPath: [
            { executablePath: '/Applications/HuaTuo Studio.app/exe', dataPath: '/Volumes/Ext1/Data' },
            { executablePath: '/Applications/HuaTuo Studio Dev.app/exe', dataPath: '/Volumes/Ext2/DevData' }
          ]
        })
      )
