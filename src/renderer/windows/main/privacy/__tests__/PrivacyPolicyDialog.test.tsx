...
describe('privacy policy resource selection', () => {
  ...
  it('builds a Windows-safe dark theme file URL', () => {
    expect(buildPrivacyPolicyUrl('C:\\Program Files\\HuaTuo Studio\\resources', 'zh-TW', ThemeMode.dark)).toBe(
      'file:///C:/Program%20Files/HuaTuo%20Studio/resources/cherry-studio/privacy-zh.html?theme=dark'
    )
  })
})
...
describe('PrivacyPolicyDialog', () => {
  beforeEach(() => {
    ...
    mocks.ipcRequest.mockResolvedValue({ resourcesPath: '/Applications/HuaTuo Studio.app/Contents/Resources' })
  })
  ...
  it('loads the local policy with the active language and theme', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTitle('privacy_policy.title')).toHaveAttribute(
        'src',
        'file:///Applications/HuaTuo%20Studio.app/Contents/Resources/cherry-studio/privacy-en.html?theme=light'
      )
    })
