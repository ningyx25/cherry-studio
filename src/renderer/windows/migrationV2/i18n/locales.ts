...
export const zhCN = {
  ...
  migration: {
    ...
    diagnostics: {
      ...
      saving: '正在保存…',
      export_description:
        '诊断包包含迁移错误、系统信息和可用的应用日志。日志可能包含文件路径、错误堆栈、用户内容或凭据；文件只会保存到本地，不会自动上传，请仅发送给 HuaTuo Studio 支持团队。',
      open_from_error: '导出此错误的诊断包',
      saved_title: '诊断包已保存',
      privacy:
        '应用日志可能包含文件路径、错误堆栈、用户内容或凭据，请勿分享到公开渠道或提供给 HuaTuo Studio 支持团队之外的人员。',
    ...
    introduction: {
      title: '将数据迁移到新的架构中',
      subtitle: 'HuaTuo Studio V2 · 全新数据架构',
      features: {
        architecture: {
          title: '全新数据架构',
    ...
    version_incompatible: {
      title: '版本升级提示',
      preamble: 'HuaTuo Studio 对数据存储进行了重大重构，为了保证旧数据的安全迁移，我们对升级顺序有严格要求。',
      no_version_log:
...
export const enUS = {
  ...
  migration: {
    ...
    diagnostics: {
      ...
      saving: 'Saving…',
      export_description:
        'The bundle includes migration errors, system information, and available application logs. Logs may contain file paths, error stacks, user content, or credentials. It is saved locally and never uploaded automatically; share it only with HuaTuo Studio support.',
      open_from_error: 'Export a diagnostic bundle for this error',
      saved_title: 'Diagnostic bundle saved',
      privacy:
        'Application logs may contain file paths, error stacks, user content, or credentials. Do not share them publicly or with anyone outside the HuaTuo Studio support team.',
      saved_local:
    ...
    introduction: {
      ...
      subtitle: 'HuaTuo Studio V2 · New Data Architecture',
      features: {
        architecture: {
    ...
    completed: {
      title: 'Welcome to HuaTuo Studio V2',
    ...
    version_incompatible: {
      ...
      preamble:
        'HuaTuo Studio has undergone a major data storage refactoring. To ensure safe migration of your data, we have strict requirements on the upgrade order.',
      no_version_log:
