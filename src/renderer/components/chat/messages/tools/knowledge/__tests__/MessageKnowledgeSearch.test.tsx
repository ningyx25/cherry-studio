...
describe('MessageKnowledgeSearchToolTitle', () => {
  it('wraps result details in the shared disclosure container', async () => {
        ...
        toolResponse={
          {
            ...
            status: 'done',
            arguments: { query: 'HuaTuo Studio', baseIds: ['base-1'] },
            response: [{ id: 1, content: 'HuaTuo Studio', score: 0.9 }]
    ...
    expect(await screen.findByText('HuaTuo Studio')).toBeInTheDocument()
  })
})
