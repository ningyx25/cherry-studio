...
Guidelines for designing RESTful APIs in the HuaTuo Studio Data API system.
...
HuaTuo Studio has two cache layers with different key shapes and different invalidation matchers. They look similar but **are not interchangeable**:
