...
HuaTuo Studio 数据重构项目的自动化工具集，用于管理数据分类和生成 TypeScript 代码。
...
根据 HuaTuo Studio 数据重构架构，所有数据需要分类到以下 6 个类别之一：
...
**已知字段清单**（参考 [PR #10162 comment](https://github.com/ningyx25/cherry-studio/pull/10162#issuecomment-4010796619)）:
